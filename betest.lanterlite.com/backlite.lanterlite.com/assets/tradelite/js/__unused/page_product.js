...
function init() {
	...
	dots.setAttribute('class', 'product-dots')

	var td1 = document.createElement('td')
	td1.setAttribute('class', 'col-1 product-slide-image')
	...
	subtitle.setAttribute('id', 'product_subtitle_desc')
	subtitle.setAttribute('class', 'col-text')
	italic.appendChild(subtitle)

	var title = document.createElement('div')
	title.setAttribute('id', 'product_title_desc')
	...
	product.setAttribute('class', 'product-page')
	product.appendChild(home)
	product.appendChild(post2)
...
function setSlide() {
  ...
  div_subtitle.setAttribute('style', style)
	...
	var table = document.createElement('table')
	table.setAttribute('class', 'product_slide_table')
...
function page_set() {
	...
	function setDots() {
		...
		var div_slide = document.querySelector('.product-dots')
    ...
    style += "line-height: " + parseInt(FF_SIZE+10)  + "px;"
		...
		if (obj['link'] != '') {
			...
			console.log(obj['link'].length)
			for (var i=0; i<obj['link'].length; i++) {
				var div = str_to_elm('<div>'+
					'</div>'
				)
				var a = str_to_elm('<a target="_blank" href="'+obj['link'][i]['url']+'">'+obj['link'][i]['title']+'</a>')
	...
	var pt = document.getElementById('product_title_desc')
	var style = ([
		'padding:10px;',
		'font-size: 25px;',
	]).join(' ')
	...
	var pst = document.getElementById('product_subtitle_desc')
	var style = ([
		'padding:10px;',
		'font-size: 33px;',
	]).join(' ')
