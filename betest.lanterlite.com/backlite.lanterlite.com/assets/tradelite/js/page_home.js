...
function text_get(count) {
	// getLangFromBackend(URL[KEYS[count]], function(obj) {
	// 	TXT[KEYS[count]] = obj[DATA]
	// 	SET[count]()
	// 	count += 1
...
function page_set() {
    ...
    img.setAttribute('style', style)
  	...
  	div_1.setAttribute('style', 'font-size: 24px; text-align: left; font-family: Crimson; line-height: 24px; color: black; /* font-size: 14px; */ font-weight: 400; /* height: 40px; */ padding: 0px 0px 5px 0px; letter-spacing: normal; text-align: left; overflow: hidden; margin: 0px 0px 5px 0px; /* color: rgba(49, 53, 59, 0.88); */')

		var div_date = document.createElement('div')
		div_date.innerHTML = obj["price"]
		var style = ""
    ...
    style += "line-height: " + parseInt(FF_SIZE+10)  + "px;"
		...
		if (APP_TYPE == 'amp')
			a.addEventListener('click', function() { change_page_by_url(obj['link']['url']) })
		else
