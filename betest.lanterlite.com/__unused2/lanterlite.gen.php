...
// 			echo json_encode(json_save($headers[FILE_DIR], $headers[FILE_NAME], $data[DATA]));
// 		}
// 		else if ($headers[FUNC_NAME] == 'json_to_php') {
// 			header('Content-Type: application/json');
// 			echo json_encode(json_to_php($headers[FILE_DIR], $data[DATA]));
// 		}
// 		else if ($headers[FUNC_NAME] == 'root_word') {
// 			// echo $data[DATA];
// 			header('Content-Type: application/json');
// 			echo root_word($data[DATA]);
// 		}		else if ($headers[FUNC_NAME] == 'saveFileText') {
// 			header('Content-Type: application/json');
// 			echo json_encode(saveFileText($data[DATA], $headers[FILE_PATH]));
// 		}
// 	}
// }
...
// 		header('Content-Type: application/json');
// 		echo json_encode(json_read($headers[FILE_DIR] . $headers[FILE_NAME]));
// 	}
// 	else if ($headers[FUNC_NAME] == 'getFileNamesInsideDir') {
// 		header('Content-Type: application/json');
// 		echo json_encode(getFileNamesInsideDir($headers[FILE_DIR]));
// 	}	else if ($headers[FUNC_NAME] == 'readFileText') {
// 		header('Content-Type: application/json');
// 		echo json_encode(readFileText($headers[FILE_PATH]));
// 	}
// }
...
function write_log($filedir, $txt) {
...
function get_arr_from_to($arr, $from, $to) {
...
function arr_value_remove_by_index($arr, $index) {
	unset($arr[$index]);
