  ...
  function set() {
    var page = page_team
		...
		'<div class="page_team">'+
			...
			'<div class="poster">'+
			'<div class="section_title theme theme_font top_title2">'+'Team Member'+'</div>'+
    ...
    var page = page_team
		...
		if (go) {
			...
			var _obj = {
				"func": "get_data",
				"json": {
					"dir": "assets/www.lanterlite.com/lang/page_team/description/"+LGen.citizen.lang+".lgd", 
					"type": "lgd"
				}
			}
			...
			var _obj = {
				"func": "get_data",
				"json": {
					"dir": "assets/www.lanterlite.com/lang/page_team/members/"+LGen.citizen.lang+".lgd", 
					"type": "lgd"
				}
			}
			LGen.f.send_get('update.lanterlite.com/update/', _obj, function(obj) {
