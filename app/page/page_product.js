  ...
  function set() {
    var page = page_product
		...
		'<div class="page_product">'+
			...
			'<div class="poster">'+
			'<div class="section_title theme theme_font top_title2">'+'Product'+'</div>'+
    ...
    var page = page_product
		...
		if (go) {
			var _obj = {
				"func": "get_data",
				"json": {
					"dir": "assets/www.lanterlite.com/lang/page_product/banners/"+LGen.citizen.lang+".lgd", 
					"type": "lgd"
				}
			}
			...
			var _obj = {
				"func": "get_data",
				"json": {
					"dir": "assets/www.lanterlite.com/lang/page_product/products/"+LGen.citizen.lang+".lgd", 
					"type": "lgd"
				}
			}
			LGen.f.send_get('update.lanterlite.com/update/', _obj, function(obj) {
