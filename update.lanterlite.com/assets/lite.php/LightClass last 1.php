...
class LightClass {
	...
	public function post_ask_to_join_guild($char_id, $asked_char_id, $guild_id) {
		...
		$date = new DateTime();
		$confirmation_id = md5($date->getTimestamp());
	...
	// public function post_ask_to_join_guild2($char_id, $asked_char_id, $guild_id) {
	// 	$dir = BASE_DIR .'/storages/light/';
	// 	// handle ask for guild confirmation
	// 	$asked_char_data = $this->L->json_read($dir . 'players_status/'.$asked_char_id)[DATA];
	// 	$asked_char_data['char_guild']['asked_guild'] = $guild_id;
	// 	$asked_char_data['char_guild']['asked_by'] = $char_id;
	// 	$asked_char_data['char_guild']['is_waiting_for_confirmation'] = true;
	// 	$this->L->json_save($dir.'players_status/', $asked_char_id, $asked_char_data, $minify=false);
	// 	return true;
	// }
	...
	public function post_confirm_guild($confirmation_id, $is_agreed) {
		...
		if ($is_agreed) {
			...
			array_push($guilds['member'], $asked_to_data['char_id']);
	...
	// public function post_confirm_no_guild($char_id) {
	// 	$dir = BASE_DIR .'/storages/light/';
	// 	$player_main_data = $this->L->json_read($dir . 'players_status/'.$char_id)[DATA];
	// 	$player_main_data['char_guild']['asked_by'] = null;
	// 	$player_main_data['char_guild']['asked_guild'] = null;
	// 	$player_main_data['char_guild']['is_waiting_for_confirmation'] = false;
	// 	$this->L->json_save($dir.'players_status/', $char_id, $player_main_data, $minify=false);
	// 	return true;
	// }
