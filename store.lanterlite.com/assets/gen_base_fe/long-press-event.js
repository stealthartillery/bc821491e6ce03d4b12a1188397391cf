...
(function (window, document) {
    ...
    function startLongPressTimer(e) {
	    	if ($(e.target).hasClass('long-press') && !$(e.target).hasClass('active-bgclr')) {
	        $(e.target).addClass('hover')
	        lprint(e.target)
	    	}
	    	else if ($(e.target.parentElement).hasClass('long-press') && !$(e.target.parentElement).hasClass('active-bgclr')) {
	        $(e.target.parentElement).addClass('hover')
	        lprint(e.target)
	    	}
        ...
        setTimeout(function() {
          ...
          $(e.target.parentElement).removeClass('hover')
        }, longPressDelayInMs)
    }
