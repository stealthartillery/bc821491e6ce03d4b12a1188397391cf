...
defined('BASE_URL') OR define('BASE_URL', 'https://www.lanterlite.com/');
defined('HOME_URL') OR define('HOME_URL', 'https://www.lanterlite.com/');
defined('BASE_DIR') OR define('BASE_DIR', FCPATH);
defined('HOME_DIR') OR define('HOME_DIR', FCPATH);

defined('HOST') OR define('HOST', 'https://www.lanterlite.com');
