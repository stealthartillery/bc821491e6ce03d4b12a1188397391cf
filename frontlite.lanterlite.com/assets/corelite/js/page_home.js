...
function showSlides() {
  ...
  try {
    ...
    document.getElementById('slide_image').style.background = "black url(" + FE_BASE_URL + 'assets/corelite/img/' + TXT['page']['slide'][slideIndex-1]['img'] + ") no-repeat 50%"
...
function page_set() {
	...
	function content_create(obj) {
		...
		var img = document.createElement('img')
		img.setAttribute('src', FE_BASE_URL + 'assets/corelite/img/' + obj["img"])
		var style = ([
			'display: block;',
    	'width: 97.5%;',
	    'border-radius: 5px;',
