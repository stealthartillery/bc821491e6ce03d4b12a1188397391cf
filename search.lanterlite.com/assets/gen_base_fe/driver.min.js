...
LGen.intro = new function () {
	...
	this.open = function (obj) {
		...
		var driver = new Driver({
		    ...
		    allowClose: false,
		    padding: 0,
	      doneBtnText: LGen.translator.get({"from_lang":"en", "words":"Done"}), 
			  closeBtnText: LGen.translator.get({"from_lang":"en", "words":"Close"}),
			  nextBtnText: LGen.translator.get({"from_lang":"en", "words":"Next"}), 
			  prevBtnText: LGen.translator.get({"from_lang":"en", "words":"Back"}),
		});
		driver.defineSteps(obj)
		driver.start();
	}
	...
	function get (obj) {
		...
		return LGen.call({'c':'white','f':'get'})({'val':LGen.intro.obj,'safe':'safe'})
	}
	...
	function set(obj) {
		...
		if (LGen.call({'c':'black','f':'check'})({'val':LGen.intro.obj, 'safe':'safe'}))
			var cnf = LGen.call({'c':'white','f':'get'})({'val':LGen.intro.obj,'safe':'safe'})
		else
			var cnf = {}
		...
		for (var i=0; i<keys.length; i++) {
			cnf[keys[i]] = obj[keys[i]]
		}

		LGen.intro.obj = LGen.call({'c':'black','f':'get'})({'val':cnf,'safe':'safe'})
		LGen.storage.setItem('app.intro.'+LGen.app.get({'safe':'safe'}).codename, LGen.intro.obj)
	}
	...
	this.reset = function() {
		LGen.call({'c':'gen','f':'read_file'})(LGen.system.get({'safe':'safe'}).home_url + "app/app.intro.lgen", function(obj) {
			...
			LGen.storage.setItem('app.intro.'+LGen.app.get({'safe':'safe'}).codename, obj)
    	LGen.intro.obj = obj
    })
	}
}
